    ...
    public static IEnumerable<Application> CreateDefaultApplications() {
        return [
            new Application( SeedConst.ApplicationId ) {
                ...
                AllowedCorsOrigins = "",
                RedirectUri = "https://localhost:16001/,https://localhost:16003/,http://localhost:16100/,http://localhost:30101/swagger/oauth2-redirect.html,http://localhost:30102/swagger/oauth2-redirect.html",
