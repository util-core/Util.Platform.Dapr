...
/// 模块服务
/// </summary>
public class ModuleService : ModuleServiceBase<IIdentityUnitOfWork,Resource,Application,Module, ModuleDto, CreateModuleRequest, ResourceQuery>, IModuleService {
    /// <summary>
    /// 初始化模块服务
    /// </summary>
